...
def get_wallet_rpc_url(coin: str):
    ...
    if coin_family == "TRTL" or coin_family == "CCX" :
        return "http://"+getattr(config,"daemon"+coin,config.daemonXMS).walletservice + '/json_rpc'
    elif coin_family == "XMR":
        return "http://"+getattr(config,"daemon"+coin,config.daemonXMS).wallethost + ":" + \
            str(getattr(config,"daemon"+coin,config.daemonXMS).walletport) \
            + '/json_rpc'
